...
<script type="text/javascript">
    ...
    var boxSizeArray = [6,6,6,6,6,6];	// Array indicating how many items there is rooom for in the right column ULs
            ...
            <table class="form-table" cellpadding="3" cellspacing="0">
                <tr>
                    <td>
                                    ...
                                    <tr>
                                        ...
                                        <!--<td>
                                            <div>
                                                <ul id="box2">
                                                    <?php
                                                    /*$boxArr = json_decode(get_option('cat_box2'));
                                                    if(count($boxArr) > 0){
                                                        $args = array(
                                                            'hide_empty' => 0,
                        ...
                        <div class="description">Each block max items = 6</div>
                    </td>
                </tr>
            </table>
